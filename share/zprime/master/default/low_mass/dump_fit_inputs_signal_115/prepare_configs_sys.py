...
input:
    input_path: "zprime/data_frames/22-0126-sys/low_mass/{p_variation}/zprime_low_m_quadtype_2_new_mc.feather"
...
apply:
    ...
    fit_df:
        branches:
            - "mz1"
            - "mz2"
        save_dir: "zprime/data_frames_fit/22-0126-sys/low_mass/{p_variation}"
