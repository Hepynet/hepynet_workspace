basic = """config:
    include:
        - "share/zprime/default_train/low_mass/train_best_limit.yaml"
...
input:
    input_path: "zprime/data_frames/21-0120-sys/low_mass/{p_variation}/zprime_low_m_quadtype_2.feather"
...
apply:
    ...
    fit_df:
        branches:
            - "mz1"
            - "mz2"
        save_dir: "zprime/data_frames_fit/21-0120-sys-best-limit/low_mass/{p_variation}"
