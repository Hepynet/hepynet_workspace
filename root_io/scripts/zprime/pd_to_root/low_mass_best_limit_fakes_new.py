...
df_dir = pathlib.Path("/data/zprime/data_frames_fit/21-0120-sys-best-limit/low_mass")
ntup_dir = pathlib.Path("/data/zprime/ntuples_fit/21-0120-sys-best-limit/low_mass")
