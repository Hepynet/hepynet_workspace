...
# setups
ntup_dir = pathlib.Path(f"/data/zprime/ntuples/21-0120-sys/powheg")
...
bkg_names = {
    "bkg_qcd_powheg": "tree_361603_16a",
}
wt_scale = 139.0 / 36.1
identifier = "qcd_powheg"
var = "tree_NOMINAL"
...
save_path = save_dir / f"zprime_low_m_quadtype_2_{identifier}.feather"
...
save_dir.mkdir(parents=True, exist_ok=True)
save_path = save_dir / f"zprime_high_m_quadtype_2_{identifier}.feather"
print(f"## Saving to {save_path}")
