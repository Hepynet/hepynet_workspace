...
save_path = save_dir / "zprime_low_m_quadtype_2_fakes_data.feather"
...
save_dir.mkdir(parents=True, exist_ok=True)
save_path = save_dir / "zprime_high_m_quadtype_2_fakes_data.feather"
print(f"## Saving to {save_path}")
