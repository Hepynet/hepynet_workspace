...
# setups
ntup_dir = pathlib.Path(f"/data/zprime/ntuples/21-0120-sys/fakes")
...
save_path = save_dir / "zprime_low_m_quadtype_2_mc_fakes.feather"
...
save_dir.mkdir(parents=True, exist_ok=True)
save_path = save_dir / "zprime_high_m_quadtype_2_mc_fakes.feather"
print(f"## Saving to {save_path}")
