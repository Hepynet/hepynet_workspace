...
# setups
ntup_dir = pathlib.Path(f"/data/zprime/ntuples/22-0125-sys")
df_dir = pathlib.Path(f"/data/zprime/data_frames/22-0126-sys")
...
for var in variations:
    ...
    save_path = save_dir / "zprime_low_m_quadtype_2_new_mc.feather"
    ...
    save_dir.mkdir(parents=True, exist_ok=True)
    save_path = save_dir / "zprime_high_m_quadtype_2_new_mc.feather"
    print(f"## Saving to {save_path}")
