...
input_array_dir = pathlib.Path("/data/zprime/arrays_fit/fit_ntup_1201_high/run2")
ntup_save_dir = pathlib.Path("/data/zprime/ntuples_fit/1201_stats/high_mass/run2")
